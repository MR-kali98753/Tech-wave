...
var require_trimEnd = __commonJS({
  "node_modules/lodash/trimEnd.js"(exports, module) {
    ...
    function trimEnd5(string, chars, guard) {
...
var require_use_sync_external_store_shim_development = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.development.js"(exports) {
    ...
    (function() {
      ...
      var React16 = require_react(), objectIs = "function" === typeof Object.is ? Object.is : is2, useState3 = React16.useState, useEffect5 = React16.useEffect, useLayoutEffect3 = React16.useLayoutEffect, useDebugValue3 = React16.useDebugValue, didWarnOld18Alpha = false, didWarnUncachedGetSnapshot = false, shim = "undefined" === typeof window || "undefined" === typeof window.document || "undefined" === typeof window.document.createElement ? useSyncExternalStore$1 : useSyncExternalStore$2;
...
var require_with_selector_development = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js"(exports) {
    ...
    (function() {
      ...
      "undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ && "function" === typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart(Error());
      var React16 = require_react(), shim = require_shim(), objectIs = "function" === typeof Object.is ? Object.is : is2, useSyncExternalStore3 = shim.useSyncExternalStore, useRef5 = React16.useRef, useEffect5 = React16.useEffect, useMemo4 = React16.useMemo, useDebugValue3 = React16.useDebugValue;
  ...
  "node_modules/lodash/fp/_baseConvert.js"(exports, module) {
    ...
    function baseConvert(util, name, func, options) {
      ...
      function castCurry(name2, func2, n2) {
        return forceCurry || config.curry && n2 > 1 ? curry(func2, n2) : func2;
      }
      ...
      function castRearg(name2, func2, n2) {
        return config.rearg && n2 > 1 && (forceRearg || !mapping.skipRearg[name2]) ? rearg(func2, mapping.methodRearg[name2] || mapping.aryRearg[n2]) : func2;
      }
...
function getMutationCacheKey(id) {
  var _a2;
  return (_a2 = "arg" in id ? id.arg.fixedCacheKey : id.fixedCacheKey) != null ? _a2 : id.requestId;
}
      ...
      updateProvidedBy: {
        reducer: function(draft, action) {
          ...
          for (var _p = 0, providedTags_1 = providedTags; _p < providedTags_1.length; _p++) {
            ...
            var subscribedQueries = (_d = (_b = (_a2 = draft[type]) != null ? _a2 : draft[type] = {})[_c = id || "__internal_without_id"]) != null ? _d : _b[_c] = [];
...
function buildSelectors(_j) {
  ...
  function buildMutationSelector() {
    return function(id) {
      ...
      var mutationId;
      if (typeof id === "object") {
        mutationId = (_a2 = getMutationCacheKey(id)) != null ? _a2 : skipToken;
      } else {
        mutationId = id;
      }
...
function getContext() {
  ...
  if (!realContext) {
    realContext = React11.createContext(null);
    if (true) {
...
function Provider2({
  ...
  const previousState = React13.useMemo(() => store.getState(), [store]);
  ...
  return React13.createElement(Context2.Provider, {
    value: contextValue
  }, children);
}
  ...
  function buildQueryHooks(name) {
    ...
    return {
      ...
      useQuery: function(arg, options) {
        ...
        (0, import_react3.useDebugValue)({ data: data2, status, isLoading, isSuccess, isError: isError2, error });
        return (0, import_react3.useMemo)(function() {
...
// node_modules/@strapi/admin/dist/admin/chunks/admin-BBS7sDVu.mjs
...
var getToken = () => JSON.parse(localStorage.getItem(STORAGE_KEYS.TOKEN) ?? sessionStorage.getItem(STORAGE_KEYS.TOKEN) ?? '""');
...
var simpleQuery = async (query, { signal }) => {
  ...
  try {
    ...
    if (typeof query === "string") {
      ...
      const { url, method = "GET", data: data2, config } = query;
      if (method === "POST") {
...
use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-X6CNA2VM.js.map
