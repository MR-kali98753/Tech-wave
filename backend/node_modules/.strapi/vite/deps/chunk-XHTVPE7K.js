...
function __variableDynamicImportRuntime1__(path) {
  switch (path) {
    case "./translations/en.json":
      return import("./en-DHxfjovA-UV5EWLQJ.js");
    case "./translations/fr.json":
      return import("./fr-XFxvAMHP-J463V7IR.js");
    default:
  ...
  register(app) {
    ...
    if (backendURL == null ? void 0 : backendURL.includes("localhost")) {
      app.addMenuLink({
        ...
        Component: async () => {
          const { App } = await import("./App-BcMkGcCg-HKPKXBOJ.js");
          return App;
        }
      });
      const plugin = {
...
//# sourceMappingURL=chunk-XHTVPE7K.js.map
