...
function __variableDynamicImportRuntime2__(path) {
  switch (path) {
    case "./translations/en.json":
      return import("./en-BixG7IBu-FTO34ADV.js");
    default:
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled(FEATURE_ID)) {
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { Router } = await import("./router-Z3AR7XZ7-SCI4QPYD.js");
          return {
            default: Router
          };
        }
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseReviewWorkflows } = await import("./purchase-review-workflows-CEP8kvxZ-7WMAEALD.js");
          return {
...
//# sourceMappingURL=chunk-7CIIRIIA.js.map
